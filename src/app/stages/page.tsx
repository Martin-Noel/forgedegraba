  ...
  return (
    ...
    >
      ...
      <section className="grid gap-8 md:grid-cols-2">
        {/* Card 1 */}
        <article className="bg-[#0f0f0f] border border-neutral-800 rounded-xl p-6 shadow-sm">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-sm text-steel">
                Couteau brut de forge · 1 à 2 personnes · 1j (5–6h) · 240€
              </p>
            </div>
          ...
          <p className="mt-4 text-gray-300">
            Lors d&apos;une journée immersive, laissez-vous envoûter par le feu
            de la forge, où vous aurez le privilège de façonner votre propre
            couteau médiéval (un couteau brut de forge sans manche en bois). Au
            terme de la journée, vous repartirez avec votre superbe couteau
            médiéval, prêt à devenir votre parfait compagnon.
          </p>

          <h3 className="mt-4 font-cinzel">
        ...
        <article className="bg-[#0f0f0f] border border-neutral-800 rounded-xl p-6 shadow-sm">
          <div className="flex items-start justify-between">
            <div>
              <h2 className="text-2xl font-cinzel mb-1">
                Stage d&apos;initiation à la coutellerie n°2
              </h2>
              <p className="text-sm text-steel">
                Réalisation d&apos;un couteau droit · 1 à 2 personnes · 1j
                (6–7h) · 320€
              </p>
            </div>
            <div className="w-20 h-20 relative opacity-80">
          ...
          <p className="mt-4 text-gray-300">
            ...
            théorique précédera la réalisation complète d&apos;un couteau droit.
          </p>
        ...
        <article className="md:col-span-2 bg-[#0f0f0f] border border-neutral-800 rounded-xl p-6 shadow-sm">
          <div className="flex items-start justify-between">
            <div>
              <h2 className="text-2xl font-cinzel mb-1">
              ...
              <p className="text-sm text-steel">
                2j · 1 personne · 440€ · 2 couteaux (brut + cuisine)
              </p>
            </div>
            <div className="w-20 h-20 relative opacity-80">
              <Image
          ...
          <div className="mt-4 grid md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <ul className="list-disc ml-5 mt-2 text-gray-300">
                ...
                <li>Travail du manche (bois ou autre selon disponibilités)</li>
